...
module.exports = {
	...
	// API key
	apikey: 'Hli/E0O6mn9Nx3eDG+MbR5Ys3M/mmgXx',
	...
	session: {
		...
		encryptionKey: 'qxuAxvge3gkFh8MiJBoiUq36YvIa+rvc1mWu6SYi7co=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'iBqW1n1IYnvv0ICqj+La96JGBE7vdFkiaCE8kAXkBhjv+hJNY8dFhHDxLnzBBb+USytcWgeZDkhS6zq2Bu/8dQ==',
		secret: 'fIvBkZW7dzEM9xG1b3zbbf4gF3LZZ8EA', // should be a large unguessable string
	...
	cookieSecret: 'DqFz+u2lObk9KvzKaDn1dm+pIAQ8jiLd',
